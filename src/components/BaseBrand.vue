...
<template>
  <div class="row">
    <div class="column gt-xs">
      <q-avatar>
        <!-- src="https://raw.githubusercontent.com/carlosepcc/cdis-quasar-vite/main/src/public/brand/imagotipo-delujo.webp?token=GHSAT0AAAAAAB2UADG7IGZP6S7MOMB4SP6IY3B5M5Q" -->

        <img
          alt=""
          src="src/public/brand/imagotipo-delujo.webp"
          width="48"
          height="48"
        />
      </q-avatar>
